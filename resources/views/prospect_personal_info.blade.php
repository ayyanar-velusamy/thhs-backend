...
@section('content')
        ...
        <form id="personal_info_form" method="POST" class="ajax-form" action="{{ route('update_personal_info', [$user->id]) }}"
            ...
            <div class="form-wrapper single_row">
                <div class="field-wrapper w-100">
                    <textarea placeholder="Special Skills" id="special_skills" name="special_skills">{{ $user->special_skills }}</textarea>
                </div>
            </div>
    ...
    <div class="modal fade" id="scheduleIntModal" tabindex="-1" role="dialog"
                        ...
                        <div class="form-wrapper">
                            ...
                            <div class="field-wrapper">
                                ...
                                <div id="interview_date_div" class="date" data-date-format="mm/dd/yyyy H:i:s">
                                    <input required type="text" name="interview_date" id="interview_date" readonly

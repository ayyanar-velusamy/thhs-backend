  ...
  <div class="container">
    <div class="register-page-parent">
      ...
      <div class="form-wrapper">
        ...
        @csrf
          <input type="text" name="email" placeholder="Username" value="{{ old('email') }}" required autocomplete="email" autofocus />

          <div class="password-wrapper position-relative">
            <input type="password" name="password" placeholder="Password" required /><i class="icon icon-eye"></i>
          </div>

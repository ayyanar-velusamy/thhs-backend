...
<section class="form-section bg-white">
  <form id="staff_demographics_form" method="POST" class="ajax-form page-form"  action="{{route('staffs.update_demographics', [$user->id])}}" role="form" enctype="multipart/form-data" >
